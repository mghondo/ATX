...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float_Pouch_Holographic_Assortment.jpg',
        category: '',
        title: '',
        css: {},
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Back.jpg',
        category: '',
        title: '',
        css: {},
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Blue Package.jpg',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Blue.jpg',
        category: 'Blue',
        title: '',
        css: {},
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Green Package.jpg',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Green.jpg',
        category: 'Green',
        title: '',
        css: {},
    },
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Pearl Package.jpg',
        category: 'Pearl Package',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Pearl.jpg',
        category: 'Pearl',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Pink Package.jpg',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Pink.jpg',
        category: 'Pink',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Red Package.jpg',
        category: 'Red Package',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Red.jpg',
        category: 'Red',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Yellow Package.jpg',
        category: 'Yellow Package',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float Pouch_Holographic Yellow.jpg',
        category: 'Yellow',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
...
class FloatPouchHolo extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div className="rn-page-title-area pt--120 pb--190 bg_image" data-black-overlay="3" style={{ backgroundImage: `url(/assets/images/NewImages10.23.2023/Merchandise/Float_Pouch_Holographic/Float_Pouch_Holographic_Assortment.jpg)`, backgroundPosition: 'center 25%', }}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    ...
                                    <p style={{ fontFamily: 'Brice-Light', color: 'white' }} data-aos="fade-up" data-aos-duration="750">Holographic Assortment</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light' }}>SKU: ATX-FP05-H</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                <div className="text-center" style={{ display: 'block', marginBottom: '30px' }}>
                                                    <img src="/assets/images/barCodes/FloatPouchHolo.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'center', fontSize: '1rem' }}>
                                                    Assorted Packaging: Master Carton: 180pcs
                                                    Inner Carton: 30pcs
                                                    (5 Blue, 5 Green, 5 Pink, 5 Yellow,
                                                    5 Red, 5 White)</h4>
                                            </div>
                                            <div className="port-view">
                                        ...
                                        <div className="portfolio-view-list d-flex flex-wrap" style={{ paddingTop: '30px', justifyContent: 'center' }}>
                                            ...
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'left' }} data-aos="fade-left">Green</h4>
                                            </div>
                                            ...
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'left' }} data-aos="fade-down">White (Pearl)</h4>
                                            </div>
                                        </div>

...
class Header extends Component{
    ...
    render(){
        ...
        return(
            <header className={`header-area formobile-menu header--transparent ${color}`}     style={{
                backgroundImage: `url('./portfolio-static-07.jpg')`, // Use the relative path to your image
              }}>
